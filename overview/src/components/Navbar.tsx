...
export const Navbar = () => {
  ...
  if (currentPath.includes("/overview")) activePageId = "/"; // Since root index is main overview, let's use "/"
        ...
        {isStoryOpen && (
          ...
          >
            <button 
              ...
              className="absolute top-6 right-6 p-2 text-white/50 hover:text-white hover:bg-white/10 rounded-full transition-colors z-110">
              <X
                  size={24}
      ...
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <motion.nav
          ...
          className={`bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl overflow-hidden relative z-50 rounded-4xl ${
            isOpen ? "rounded-4xl w-full max-w-4xl" : "rounded-full w-auto"
          }`}
          transition={{
            type: "spring",
            stiffness: 220,
